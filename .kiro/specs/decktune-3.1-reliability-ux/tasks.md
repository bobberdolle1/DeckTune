...
- [x] 1. Implement CrashMetricsManager





  - [x] 1.1 Create CrashRecord and CrashMetrics dataclasses
  ...
  - [x] 1.2 Write property test for crash history FIFO limit


    - **Property 1: Crash history FIFO limit**
    - **Validates: Requirements 1.5**
  - [x] 1.3 Implement CrashMetricsManager class
  ...
  - [x] 1.4 Write property test for crash record completeness


    - **Property 2: Crash record completeness**
    - **Validates: Requirements 1.3**
  - [x] 1.5 Integrate CrashMetricsManager with SafetyManager
...
- [x] 3. Implement TelemetryManager




  - [x] 3.1 Create TelemetrySample dataclass


    - Define fields: timestamp, temperature_c, power_w, load_percent
    - Add serialization methods
    - _Requirements: 2.1, 2.2_
  - [x] 3.2 Write property test for telemetry buffer circular behavior


    - **Property 3: Telemetry buffer circular behavior**
    - **Validates: Requirements 2.5**
  - [x] 3.3 Implement TelemetryManager class


    - Use collections.deque with maxlen=300
    - Implement record_sample(), get_recent(seconds), get_all()
    - _Requirements: 2.1, 2.2, 2.5_
  - [x] 3.4 Integrate TelemetryManager with DynamicController
...
- [x] 4. Implement PlatformCache




  - [x] 4.1 Create CachedPlatform dataclass


    - Define fields: model, variant, safe_limit, cached_at
    - Add JSON serialization
    - _Requirements: 3.1_
  - [x] 4.2 Write property test for platform cache validity


    - **Property 4: Platform cache validity**
    - **Validates: Requirements 3.3**
  - [x] 4.3 Write property test for cache corruption resilience


    - **Property 5: Platform cache corruption resilience**
    - **Validates: Requirements 3.5**
  - [x] 4.4 Implement PlatformCache class
  ...
  - [x] 4.5 Integrate PlatformCache with detect_platform()
...
- [x] 6. Implement SessionManager




  - [x] 6.1 Create Session and SessionMetrics dataclasses
  ...
  - [x] 6.2 Write property test for session history limit


    - **Property 6: Session history limit**
    - **Validates: Requirements 8.7**
  - [x] 6.3 Write property test for session metrics calculation


    - **Property 7: Session metrics calculation**
    - **Validates: Requirements 8.3**
  - [x] 6.4 Implement SessionManager class
  ...
  - [x] 6.5 Write property test for session comparison symmetry


    - **Property 15: Session comparison symmetry**
    - **Validates: Requirements 8.6**
  - [x] 6.6 Integrate SessionManager with DynamicController
...
- [x] 8. Implement StatusStreamManager (SSE)
  ...
  - [x] 8.1 Create StatusStreamManager class
  ...
  - [x] 8.2 Write property test for status buffer limit


    - **Property 9: Status buffer limit**
    - **Validates: Requirements 4.5**
  - [x] 8.3 Write property test for no events when stopped


    - **Property 10: No events when stopped**
    - **Validates: Requirements 4.3**
  - [x] 8.4 Integrate StatusStreamManager with DynamicController
...
- [x] 9. Implement SetupWizard (Frontend)
  ...
  - [x] 9.1 Create WizardState types and goal estimates


    - Define TypeScript interfaces for wizard state
    - Define GOAL_ESTIMATES constant with battery/temp estimates
    - _Requirements: 5.3, 5.4_
  - [x] 9.2 Write property test for wizard cancellation safety


    - **Property 8: Wizard cancellation safety**
    - **Validates: Requirements 5.7**
  - [x] 9.3 Write property test for goal estimates availability


    - **Property 11: Goal estimates availability**
    - **Validates: Requirements 5.4**
  - [x] 9.4 Implement SetupWizard component
  ...
  - [x] 9.5 Add first-run detection and wizard trigger
...
- [x] 11. Implement TelemetryGraph (Frontend)
  ...
  - [x] 11.1 Create TelemetryGraph component
  ...
  - [x] 11.2 Integrate TelemetryGraph with SSE updates
...
- [x] 12. Implement SessionHistory UI (Frontend)
  ...
  - [x] 12.2 Create SessionDetail component
    ...
    - _Requirements: 8.5_
  - [x] 12.3 Create SessionComparison component
...
- [x] 13. Implement Rust Config Fuzzing
  ...
  - [x] 13.1 Add cargo-fuzz to gymdeck3
  ...
  - [x] 13.2 Write property test for fuzzing no-panic guarantee



    - **Property 12: Fuzzing no-panic guarantee**
    - **Validates: Requirements 6.1, 6.2**
  - [x] 13.3 Implement graceful error handling in config parser
...
- [x] 14. Implement Frontend-Backend Integration Tests
  ...
  - [x] 14.1 Write property test for RPC response schema compliance
  ...
  - [x] 14.2 Write property test for error response structure


    - **Property 14: Error response structure**
    - **Validates: Requirements 7.4**
  - [x] 14.3 Create RPC contract test suite
...
- [x] 15. Add RPC methods for new features




  - [x] 15.1 Add crash metrics RPC methods


    - get_crash_metrics() -> CrashMetrics
    - _Requirements: 1.2_

  - [x] 15.2 Add telemetry RPC methods
  ...
  - [x] 15.4 Add platform cache RPC methods
